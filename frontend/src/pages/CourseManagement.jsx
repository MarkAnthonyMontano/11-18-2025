...
const CourseManagement = () => {
  ...
  // 🔹 Menu Items
  const menuItems = [
    { title: "PROGRAM TAGGING PANEL", link: "/program_tagging", icon: <CollectionsBookmark /> },
    { title: "PROGRAM PANEL FORM", link: "/program_panel", icon: <LibraryBooks /> },
    { title: "CREATE CURRICULUM", link: "/curriculum_panel", icon: <EditNote /> },
    { title: "COURSE PANEL FORM", link: "/course_panel", icon: <MenuBook /> },
  ];
